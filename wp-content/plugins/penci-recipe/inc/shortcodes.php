...
function penci_recipe_control_actions(){
	if( get_theme_mod( 'penci_recipe_jump_button' ) || get_theme_mod('penci_recipe_print_btn') ){
		...
		if( get_theme_mod( 'penci_recipe_jump_button' ) ):
			...
			?>
			<a class="penci-recipe-button penci-jump-recipe" href="#penci-recipe-card"><?php ( function_exists( 'penci_fawesome_icon' ) ? penci_fawesome_icon( 'fas fa-arrow-down' ) : '<i class="fa fa-angle-down"></i>' ); echo $jump_text; ?></a>
			<?php
		endif;
		if( get_theme_mod( 'penci_recipe_print_btn' ) ):
			...
			?>
			<a class="penci-recipe-button penci-recipe-print-btn penci-printbutton-recipe" href="#" data-print="<?php echo plugin_dir_url( __FILE__ ) . 'print.css?ver='. PENCI_RECIPE_VER; ?>"><?php ( function_exists( 'penci_fawesome_icon' ) ? penci_fawesome_icon( 'fas fa-print' ) : '<i class="fa fa-print"></i>' ); echo $printbtn_text; ?></a>
			<?php
		endif;
		echo '</div>';
	}
...
function penci_recipe_shortcode_function( $atts, $content = null ) {
	...
	<?php if( get_theme_mod('penci_recipe_make_trecipe') ): ?>
		<div class="penci-recipe-tagged">
			<span class="prt-wrap-span prt-icon"><span><?php ( function_exists( 'penci_fawesome_icon' ) ? penci_fawesome_icon( 'fab fa-instagram' ) : '<i class="fa fa-instagram"></i>' ); ?></span></span>
...
function penci_recipe_index_function( $atts, $content = null ) {
	...
	<div class="penci-recipe-index-wrap">
		...
		<?php if ( $index_cat_link == "yes" && $cat_link && ( $post_found > $index_numbers_posts ) ) : ?>
			<div class="penci-index-more-link"><a href="<?php echo esc_url( $cat_link ); ?>"><?php echo do_shortcode( $index_cat_text ); ?> <?php ( function_exists( 'penci_fawesome_icon' ) ? penci_fawesome_icon( 'fas fa-long-arrow-alt-right' ) : '<i class="fa fa-long-arrow-right"></i>' ); ?></a></div>
		<?php endif; ?>

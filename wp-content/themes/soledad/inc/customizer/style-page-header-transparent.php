...
if ( ! function_exists( 'pencidesign_customizer_css_page_header_transparent' ) ):
	function pencidesign_customizer_css_page_header_transparent() {
		...
		<?php if ( $social_color ): ?>
			.penci-header-trans #navigation:not(.sticky-active) .header-social a i,
			.penci-header-trans .sticky-wrapper:not( .is-sticky ) .header-social a i,
			.penci-header-trans #navigation:not(.sticky-active) .main-nav-social a,
			...
			.penci-header-trans #navigation:not(.sticky-active) .penci-menuhbg-toggle .lines-button:after,
			.penci-header-trans #navigation:not(.sticky-active) .penci-menuhbg-toggle .penci-lines:before,
			.penci-header-trans #navigation:not(.sticky-active) .penci-menuhbg-toggle .penci-lines:after,
		...
		<?php if ( $social_color_hover ): ?>
			.penci-header-trans .header-social a:hover i, .penci-header-trans .header-social a:hover i, .penci-header-trans #navigation:not(.sticky-active) .main-nav-social a:hover,
			.penci-header-trans .sticky-wrapper:not( .is-sticky ) .main-nav-social a:hover {   color: <?php echo esc_attr( $social_color_hover ); ?>; }
			.penci-header-trans #navigation:not(.sticky-active) .penci-menuhbg-toggle:hover .lines-button:after,
			.penci-header-trans #navigation:not(.sticky-active) .penci-menuhbg-toggle:hover .penci-lines:before,
			.penci-header-trans #navigation:not(.sticky-active) .penci-menuhbg-toggle:hover .penci-lines:after,
		...
		<?php if ( $main_bar_nav_color ): ?>
			.penci-header-trans #navigation:not(.sticky-active) .menu > li > a, .penci-header-trans .sticky-wrapper:not( .is-sticky ) #navigation .menu > li > a { color:  <?php echo esc_attr( $main_bar_nav_color ); ?>; }
		<?php endif; ?>
		<?php if ( $bar_color_active ): ?>
			.penci-header-trans #navigation:not(.sticky-active) .menu > li > a:hover,
			.penci-header-trans #navigation:not(.sticky-active) .menu > li.current-menu-item > a,
			.penci-header-trans #navigation:not(.sticky-active) .menu > li.current_page_item > a,
			.penci-header-trans #navigation:not(.sticky-active) .menu > li:hover > a,
			.penci-header-trans #navigation:not(.sticky-active) .menu > li.current-menu-ancestor > a,
			.penci-header-trans #navigation:not(.sticky-active) .menu > li.current-menu-item > a,
			...
			.penci-header-trans #navigation:not(.sticky-active) ul.menu > li > a:before,
			.penci-header-trans #navigation:not(.sticky-active) .menu > ul > li > a:before,
		...
		<?php if ( $main_bar_search_magnify ): ?>
			.penci-header-trans #navigation:not(.sticky-active) #top-search > a,
			.penci-header-trans #navigation:not(.sticky-active) .button-menu-mobile,
		...
		<?php if ( $main_bar_close_color ): ?>
			.penci-header-trans #navigation:not(.sticky-active) .show-search a.close-search, .penci-header-trans .sticky-wrapper:not( .is-sticky ) .show-search a.close-search{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
			.penci-header-trans #navigation:not(.sticky-active) .show-search #searchform input.search-input::-webkit-input-placeholder{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
			.penci-header-trans #navigation:not(.sticky-active) .show-search #searchform input.search-input:-moz-placeholder{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; opacity: 1;}
			.penci-header-trans #navigation:not(.sticky-active) .show-search #searchform input.search-input::-moz-placeholder{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; opacity: 1;}
			.penci-header-trans #navigation:not(.sticky-active) .show-search #searchform input.search-input:-ms-input-placeholder{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
			.penci-header-trans .sticky-wrapper:not( .is-sticky ) .show-search #searchform input.search-input::-webkit-input-placeholder{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
			.penci-header-trans .sticky-wrapper:not( .is-sticky ) .show-search #searchform input.search-input:-moz-placeholder { color: <?php echo esc_attr( $main_bar_close_color ); ?>; opacity: 1;}
			.penci-header-trans .sticky-wrapper:not( .is-sticky ) .show-search #searchform input.search-input::-moz-placeholder {color: <?php echo esc_attr( $main_bar_close_color ); ?>; opacity: 1; }
			.penci-header-trans .sticky-wrapper:not( .is-sticky ) .show-search #searchform input.search-input:-ms-input-placeholder { color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
			.penci-header-trans #navigation:not(.sticky-active) .show-search #searchform input.search-input{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
			.penci-header-trans .sticky-wrapper:not( .is-sticky ) .show-search #searchform input.search-input{ color: <?php echo esc_attr( $main_bar_close_color ); ?>; }
		<?php endif; ?>
		}
		<?php
	}

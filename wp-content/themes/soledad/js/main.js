...
(function($) {
	...
	PENCI.mobile_menu = function () {
		...
		// Open child menu items if the parent link to #
		$( '#sidebar-nav .menu li.menu-item-has-children > a, .penci-menu-hbg .menu li.menu-item-has-children > a' ).on( 'click', function ( e ) {
			var $this = $( this ),
				$href = $this.attr('href');
			if( '#' === $href ){
				e.preventDefault();
				$this.find('.indicator').children().toggleClass( 'fa-angle-up' );
